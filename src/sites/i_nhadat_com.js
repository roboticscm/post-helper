...
export const i_nhadat_com = async (browser, postId, url, username, password, post, config, autoClose) => {
    ...
    return new Promise(async (resolve, reject) => {
        ...
        // click login link
        await page.click('#ctl00_pc_header > div.reg-menu-box > div > a.login')
